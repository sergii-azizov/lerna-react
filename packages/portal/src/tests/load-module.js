...
const Button4 = loadModule(MS_NAMES.COMPONENTS, { componentName: 'Button'});
const Button5 = loadModule(MS_NAMES.COMPONENTS, { componentName: 'Button'});
const Button6 = loadModule(MS_NAMES.COMPONENTS, { componentName: 'Button'});
