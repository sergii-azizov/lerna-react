...
import { Clear, Load3Module, LoadModule, ToggleModules, ParallelToggleModules } from './tests';
    ...
    <div className={styles.root}>
        <nav>
            <ul>
                ...
                <li><Link to="/lerna-react/index.html/load-3-module">Load 3 Modules</Link></li>
        ...
        <Switch>
            ...
            <Route path="/lerna-react/index.html/load-3-module" component={Load3Module}/>
