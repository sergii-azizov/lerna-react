(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("core"), require("propTypes"), require("React"), require("reactRedux"), require("redux"));
	else if(typeof define === 'function' && define.amd)
		define("components", ["core", "propTypes", "React", "reactRedux", "redux"], factory);
	else if(typeof exports === 'object')
		exports["components"] = factory(require("core"), require("propTypes"), require("React"), require("reactRedux"), require("redux"));
	else
		root["components"] = factory(root["core"], root["propTypes"], root["React"], root["reactRedux"], root["redux"]);
})(window.__APP__, function(__WEBPACK_EXTERNAL_MODULE_core__, __WEBPACK_EXTERNAL_MODULE_prop_types__, __WEBPACK_EXTERNAL_MODULE_react__, __WEBPACK_EXTERNAL_MODULE_react_redux__, __WEBPACK_EXTERNAL_MODULE_redux__) {
